...
class GenerateReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'period_type' => ['nullable', 'string', Rule::in(['last_month', 'last_3_months', 'last_6_months', 'last_year', 'current_month', 'current_year', 'custom'])],
            'category_ids' => ['nullable', 'array'],
            'category_ids.*' => ['string', 'exists:categories,uuid'],
            'wallet_ids' => ['nullable', 'array'],
            'wallet_ids.*' => ['string', 'exists:wallets,uuid'],
